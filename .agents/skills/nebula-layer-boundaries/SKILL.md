...
The layer map in `AGENTS.md` is mechanically enforced by `cargo deny check`
...
From `AGENTS.md` "Layered Dependency Map". Each layer may depend only on layers
...
`AGENTS.md` Agent Rules: "Cross-crate communication goes through
