...
- [ ] ACT-T014 [P] Document deferred output resolution contract (who resolves, when, persistence)
- [ ] ACT-T015 [P] Document streaming output backpressure semantics and consumer contract
