...
model" deferral. Ratified by ADR-0066 (companion, this wave).
...
- **P7 — Docs/ADR.** ADR-0066 (supersede the deferral; record §2 decisions),
...
implementer (rigorous self-review substitutes; ADR-0066 records this);
...
- **ADR-0066** — `docs/adr/0066-nebula-storage-spec16-port-adapter-tenancy.md`:
