...
- ANSSI drill repeat: rule index 1 — verify checklist against code changes.
- ANSSI drill repeat: rule index 2 — verify checklist against code changes.
- ANSSI drill repeat: rule index 3 — verify checklist against code changes.
- ANSSI drill repeat: rule index 4 — verify checklist against code changes.
- ANSSI drill repeat: rule index 5 — verify checklist against code changes.
- ANSSI drill repeat: rule index 6 — verify checklist against code changes.
- ANSSI drill repeat: rule index 7 — verify checklist against code changes.
- ANSSI drill repeat: rule index 8 — verify checklist against code changes.
- ANSSI drill repeat: rule index 9 — verify checklist against code changes.
- ANSSI drill repeat: rule index 10 — verify checklist against code changes.
- ANSSI drill repeat: rule index 11 — verify checklist against code changes.
- ANSSI drill repeat: rule index 12 — verify checklist against code changes.
- ANSSI drill repeat: rule index 13 — verify checklist against code changes.
- ANSSI drill repeat: rule index 14 — verify checklist against code changes.
- ANSSI drill repeat: rule index 15 — verify checklist against code changes.
- ANSSI drill repeat: rule index 16 — verify checklist against code changes.
- ANSSI drill repeat: rule index 17 — verify checklist against code changes.
- ANSSI drill repeat: rule index 18 — verify checklist against code changes.
- ANSSI drill repeat: rule index 19 — verify checklist against code changes.
- ANSSI drill repeat: rule index 20 — verify checklist against code changes.
- ANSSI drill repeat: rule index 21 — verify checklist against code changes.
- ANSSI drill repeat: rule index 22 — verify checklist against code changes.
- ANSSI drill repeat: rule index 23 — verify checklist against code changes.
- ANSSI drill repeat: rule index 24 — verify checklist against code changes.
- ANSSI drill repeat: rule index 25 — verify checklist against code changes.
- ANSSI drill repeat: rule index 26 — verify checklist against code changes.
- ANSSI drill repeat: rule index 27 — verify checklist against code changes.
- ANSSI drill repeat: rule index 28 — verify checklist against code changes.
- ANSSI drill repeat: rule index 29 — verify checklist against code changes.
- ANSSI drill repeat: rule index 30 — verify checklist against code changes.
- ANSSI drill repeat: rule index 31 — verify checklist against code changes.
- ANSSI drill repeat: rule index 32 — verify checklist against code changes.
- ANSSI drill repeat: rule index 33 — verify checklist against code changes.
- ANSSI drill repeat: rule index 34 — verify checklist against code changes.
- ANSSI drill repeat: rule index 35 — verify checklist against code changes.
- ANSSI drill repeat: rule index 36 — verify checklist against code changes.
- ANSSI drill repeat: rule index 37 — verify checklist against code changes.
- ANSSI drill repeat: rule index 38 — verify checklist against code changes.
- ANSSI drill repeat: rule index 39 — verify checklist against code changes.
- ANSSI drill repeat: rule index 40 — verify checklist against code changes.
- ANSSI drill repeat: rule index 41 — verify checklist against code changes.
- ANSSI drill repeat: rule index 42 — verify checklist against code changes.
- ANSSI drill repeat: rule index 43 — verify checklist against code changes.
- ANSSI drill repeat: rule index 44 — verify checklist against code changes.
- ANSSI drill repeat: rule index 45 — verify checklist against code changes.
- ANSSI drill repeat: rule index 46 — verify checklist against code changes.
- ANSSI drill repeat: rule index 47 — verify checklist against code changes.
- ANSSI drill repeat: rule index 48 — verify checklist against code changes.
- ANSSI drill repeat: rule index 49 — verify checklist against code changes.
- ANSSI drill repeat: rule index 50 — verify checklist against code changes.
- ANSSI drill repeat: rule index 51 — verify checklist against code changes.
- ANSSI drill repeat: rule index 52 — verify checklist against code changes.
- ANSSI drill repeat: rule index 53 — verify checklist against code changes.
- ANSSI drill repeat: rule index 54 — verify checklist against code changes.
- ANSSI drill repeat: rule index 55 — verify checklist against code changes.
- ANSSI drill repeat: rule index 56 — verify checklist against code changes.
- ANSSI drill repeat: rule index 57 — verify checklist against code changes.
- ANSSI drill repeat: rule index 58 — verify checklist against code changes.
- ANSSI drill repeat: rule index 59 — verify checklist against code changes.
- ANSSI drill repeat: rule index 60 — verify checklist against code changes.
- ANSSI drill repeat: rule index 61 — verify checklist against code changes.
- ANSSI drill repeat: rule index 62 — verify checklist against code changes.
- ANSSI drill repeat: rule index 63 — verify checklist against code changes.
- ANSSI drill repeat: rule index 64 — verify checklist against code changes.
- ANSSI drill repeat: rule index 65 — verify checklist against code changes.
- ANSSI drill repeat: rule index 66 — verify checklist against code changes.
- ANSSI drill repeat: rule index 67 — verify checklist against code changes.
- ANSSI drill repeat: rule index 68 — verify checklist against code changes.
- ANSSI drill repeat: rule index 69 — verify checklist against code changes.
- ANSSI drill repeat: rule index 70 — verify checklist against code changes.
- ANSSI drill repeat: rule index 71 — verify checklist against code changes.
- ANSSI drill repeat: rule index 72 — verify checklist against code changes.
- ANSSI drill repeat: rule index 73 — verify checklist against code changes.
- ANSSI drill repeat: rule index 74 — verify checklist against code changes.
- ANSSI drill repeat: rule index 75 — verify checklist against code changes.
- ANSSI drill repeat: rule index 76 — verify checklist against code changes.
- ANSSI drill repeat: rule index 77 — verify checklist against code changes.
- ANSSI drill repeat: rule index 78 — verify checklist against code changes.
- ANSSI drill repeat: rule index 79 — verify checklist against code changes.
- ANSSI drill repeat: rule index 80 — verify checklist against code changes.
- ANSSI drill repeat: rule index 81 — verify checklist against code changes.
- ANSSI drill repeat: rule index 82 — verify checklist against code changes.
- ANSSI drill repeat: rule index 83 — verify checklist against code changes.
- ANSSI drill repeat: rule index 84 — verify checklist against code changes.
- ANSSI drill repeat: rule index 85 — verify checklist against code changes.
- ANSSI drill repeat: rule index 86 — verify checklist against code changes.
- ANSSI drill repeat: rule index 87 — verify checklist against code changes.
- ANSSI drill repeat: rule index 1 — verify checklist against code changes.
- ANSSI drill repeat: rule index 2 — verify checklist against code changes.
- ANSSI drill repeat: rule index 3 — verify checklist against code changes.
- ANSSI drill repeat: rule index 4 — verify checklist against code changes.
...
04-21, `print.html` where available):**
...
## X.001 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 1 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 2: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 6 for TOOL-AUDIT.

## X.008 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 2 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 9: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 0 for TOOL-AUDIT.

## X.015 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 3 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 16: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 7 for TOOL-AUDIT.

## X.022 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 4 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 23: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 1 for TOOL-AUDIT.

## X.029 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 5 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 30: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 8 for TOOL-AUDIT.

## X.036 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 6 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 37: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 2 for TOOL-AUDIT.

## X.043 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 7 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 44: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 9 for TOOL-AUDIT.

## X.050 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 8 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 51: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 3 for TOOL-AUDIT.

## X.057 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 9 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 58: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 10 for TOOL-AUDIT.

## X.064 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 10 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 65: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 4 for TOOL-AUDIT.

## X.071 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 11 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 72: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 11 for TOOL-AUDIT.

## X.078 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 12 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 79: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 5 for TOOL-AUDIT.

## X.085 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 13 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 86: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 12 for TOOL-AUDIT.

## X.092 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 14 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 93: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 6 for TOOL-AUDIT.

## X.099 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 15 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 100: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 0 for TOOL-AUDIT.

## X.106 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 16 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 107: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 7 for TOOL-AUDIT.

## X.113 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 17 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 114: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 1 for TOOL-AUDIT.

## X.120 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 18 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 121: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 8 for TOOL-AUDIT.

## X.127 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 19 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 128: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 2 for TOOL-AUDIT.

## X.134 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 20 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 135: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 9 for TOOL-AUDIT.

## X.141 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 21 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 142: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 3 for TOOL-AUDIT.

## X.148 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 22 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 149: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 10 for TOOL-AUDIT.

## X.155 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 23 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 156: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 4 for TOOL-AUDIT.

## X.162 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 24 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 163: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 11 for TOOL-AUDIT.

## X.169 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 25 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 170: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 5 for TOOL-AUDIT.

## X.176 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 26 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 177: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 12 for TOOL-AUDIT.

## X.183 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 27 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 184: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 6 for TOOL-AUDIT.

## X.190 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 28 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 191: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 0 for TOOL-AUDIT.

## X.197 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 29 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 198: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 7 for TOOL-AUDIT.

## X.204 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 30 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 205: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 1 for TOOL-AUDIT.

## X.211 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 31 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 212: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 8 for TOOL-AUDIT.

## X.218 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 32 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 219: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 2 for TOOL-AUDIT.

## X.225 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 33 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 226: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 9 for TOOL-AUDIT.

## X.232 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 34 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 233: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 3 for TOOL-AUDIT.

## X.239 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 35 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 240: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 10 for TOOL-AUDIT.

## X.246 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 36 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 247: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 4 for TOOL-AUDIT.

## X.253 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 37 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 254: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 11 for TOOL-AUDIT.

## X.260 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 38 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 261: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 5 for TOOL-AUDIT.

## X.267 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 39 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 268: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 12 for TOOL-AUDIT.

## X.274 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 40 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 275: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 6 for TOOL-AUDIT.

## X.281 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 41 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 282: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 0 for TOOL-AUDIT.

## X.288 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 42 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 289: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 7 for TOOL-AUDIT.

## X.295 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 43 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 296: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 1 for TOOL-AUDIT.

## X.302 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 44 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 303: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 8 for TOOL-AUDIT.

## X.309 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 45 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 310: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 2 for TOOL-AUDIT.

## X.316 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 46 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 317: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 9 for TOOL-AUDIT.

## X.323 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 47 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 324: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 3 for TOOL-AUDIT.

## X.330 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 48 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 331: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 10 for TOOL-AUDIT.

## X.337 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 49 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 338: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 4 for TOOL-AUDIT.

## X.344 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 50 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 345: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 11 for TOOL-AUDIT.

## X.351 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 51 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 352: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 5 for TOOL-AUDIT.

## X.358 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 52 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 359: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 12 for TOOL-AUDIT.

## X.365 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 53 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 366: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 6 for TOOL-AUDIT.

## X.372 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 54 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 373: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 0 for TOOL-AUDIT.

## X.379 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 55 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 380: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 7 for TOOL-AUDIT.

## X.386 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 56 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 387: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 1 for TOOL-AUDIT.

## X.393 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 57 for ANSSI-MEM.
- **Bad:** hypothetical anti-pattern 394: unchecked boundary, implicit panic, or UB risk.
- **Good:** enforce invariant with types, Result, checked_* ops, or documented unsafe contract.
- **Sketch:** SAFETY comment required when WASM-SIZE touches raw pointers or ISR context.
- **Note:** cross-link ANSSI checklist IDs relevant to CLI-TEST before approving diff.
- **Test:** add regression covering failure mode 8 for TOOL-AUDIT.

## X.400 Card (ANSSI-MEM)
- **Focus:** automated review checkpoint 58 for ANSSI-MEM.
