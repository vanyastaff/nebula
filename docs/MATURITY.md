...
| nebula-credential-builtin | frontier (preview — П1 scaffold; concrete types land in П3, 2026-04-26) | n/a | partial (README + crate-level rustdoc only — no concrete API surface yet) | n/a | n/a |
