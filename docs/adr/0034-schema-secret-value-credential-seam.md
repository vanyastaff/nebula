...
(`docs/ARCHIVE.md`) specifies `SecretValue`, `Zeroize`, `SecretWire`, optional KDF parameters on `SecretField`, `ResolvedValues::get_secret`, and a redacted view for loader context.
