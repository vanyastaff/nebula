...
|-------|----------------|------------------|
| **M6 integration binding** | **0081** (absorbs ADR-0042–0045, 0051, 0066–0067); **0087** (bind-population producer, proposed) | Slots, resources, rotation, credential injection |
...
## Index (live standalone, 0046–0087)
...
| [0086](./0086-nebula-env-cross-cutting-reader.md) | `nebula-env` cross-cutting typed env reader | accepted |
| [0087](./0087-bind-population-producer-resource-activation.md) | Bind-population producer — resolve & populate credential slots at resource activation | proposed |
