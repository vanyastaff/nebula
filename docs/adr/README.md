...
| [0068](./0068-nebula-storage-spec16-port-adapter-tenancy.md) | nebula-storage spec-16 port / adapter / tenancy | accepted (2026-05-17) | storage, storage-port, tenancy, engine, api, spec-16, supersession |
