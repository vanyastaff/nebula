...
Amends portions of [Strategy §3.2 / §3.3](../ARCHIVE.md) (Checkpoint 1, frozen at commit `d5045774`):
...
Inline amendments in [`docs/ARCHIVE.md`](../ARCHIVE.md):
...
- [Strategy Document](../ARCHIVE.md) — §3.2 (dyn semantics), §3.3 (pattern), §3.7 (fallbacks not triggered by this ADR).
