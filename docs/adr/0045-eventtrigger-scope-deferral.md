...
# ADR-0045: EventTrigger DX-wrapper deferral (superseded)
...
| | |
|---|---|
| **Topic** | EventTrigger wrapper explicitly deferred. |
...
Prior full text: `git log -- docs/adr/0045-eventtrigger-scope-deferral.md` before the Wave B contract merge.
