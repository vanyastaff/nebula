...
- `PoolRuntime::run_maintenance()` evicts idle-timeout, max-lifetime, and stale-fingerprint entries — caller spawns the periodic task; `PoolEntry::returned_at` tracks idle duration
...
<!-- reviewed: 2026-03-25 — pool maintenance: run_maintenance evicts idle/expired/stale entries -->
