...
//!   that persists [`StoredCredential`](nebula_credential::StoredCredential)
//!   rows.
...
//! the [`ExternalProvider`](nebula_credential::provider::ExternalProvider)
//! design that motivates [`ProviderCacheLayer`].
