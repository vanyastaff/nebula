...
impl SqliteRefreshClaimFixture {
    ...
    /// identifier-safe.
    fn trigger_name(&self, credential: &CredentialId) -> String {
...
/// credential is validated rather than escaped: `CredentialId`'s `Display` is
...
fn sql_literal(credential: &CredentialId) -> String {
