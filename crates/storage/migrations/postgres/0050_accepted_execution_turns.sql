...
CREATE TABLE port_execution_turn_acceptances (
    ...
    last_accepted_fencing_generation BIGINT NOT NULL CHECK (last_accepted_fencing_generation > 0),
...
-- The cursor advances within one exact flavor before lease eligibility filtering.
