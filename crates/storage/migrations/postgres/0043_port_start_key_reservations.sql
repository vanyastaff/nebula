...
COMMENT ON TABLE port_start_key_reservations IS
    'One row per accepted start key; written in the same transaction as the execution aggregate and its Start control row';
