//! Code generation helpers for validator and config derives.

use proc_macro2::TokenStream as TokenStream2;
use quote::quote;
use syn::Type;

use crate::{attrs, diag};

/// Parse a `usize` value from an attribute key.
...
/// Parse a numeric literal from an attribute key.
...
/// Generate a length check for a string field.
...
/// Generate a string validator check using a built-in validator expression.
...
/// Generate a regex validator check.
...
/// Return the built-in string validator flags and their constructor expressions.
...
/// Convert an `AttrValue` to a token stream.
