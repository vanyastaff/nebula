...
seam; lease как first-class. `#[property]`/unified authoring принято в
[`crates/schema/docs/PHASE5_PROPERTY.md`](../../schema/docs/PHASE5_PROPERTY.md); engine сохраняет роль consumer
`slot_bindings` и не переносит slots в parameter values.
