...
**Crate Docs**: [crates/resilience/docs/README.md](../../../crates/resilience/docs/README.md) | **Plan**: [PLAN.md](PLAN.md) | **Next Tasks**: [crates/resilience/Task.md](../../../crates/resilience/Task.md)

## Current Track

- Core phases (RSL-T001..RSL-T044) are complete.
- Active post-phase backlog is tracked in `crates/resilience/Task.md` (RSL-N001..RSL-N010).
