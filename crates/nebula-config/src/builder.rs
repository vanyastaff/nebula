...
use crate::{
    CompositeLoader, ConfigError, ConfigLoader, ConfigResult, ConfigSource, ConfigValidator,
    ConfigWatcher, SourceMetadata,
};
...
impl ConfigBuilder {
    ...
    pub async fn build(self) -> ConfigResult<Config> {
        ...
        let config = Config {
            data: Arc::new(RwLock::new(serde_json::Value::Object(
                serde_json::Map::new(),
            ))),
