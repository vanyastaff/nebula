...
//! shared small types from [`nebula_metadata`] ([`Icon`],
//! [`MaturityLevel`], [`DeprecationNotice`]) but deliberately does **not**
//! compose `BaseMetadata<K>`: a plugin is a container, not a schematized
//! leaf. See `docs/adr/0018-plugin-metadata-to-manifest.md`.

use nebula_core::PluginKey;
use nebula_metadata::{DeprecationNotice, Icon, MaturityLevel};
use semver::Version;
...
impl PluginManifestBuilder {
    ...
    pub fn build(self) -> Result<PluginManifest, PluginError> {
