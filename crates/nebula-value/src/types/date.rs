...
pub enum DateError {
    ...
    #[error("Arithmetic overflow in date operation")]
    ArithmeticOverflow,
}
...
pub struct Date {
    ...
    #[cfg_attr(feature = "serde", serde(skip))]
    day_of_year_cache: std::sync::OnceLock<u16>,
}
...
impl Date {
    ...
    pub fn new(year: i32, month: u32, day: u32) -> DateResult<Self> {
        ...
        Ok(Self {
            ...
            day_of_year_cache: std::sync::OnceLock::new(),
        })
    }
    ...
    pub fn from_year_day(year: i32, day_of_year: u16) -> DateResult<Self> {
    ...
    pub fn from_iso_week(year: i32, week: u32, weekday: u32) -> DateResult<Self> {
    ...
    #[inline]
    pub fn add_weeks(&self, weeks: i64) -> DateResult<Self> {
        self.add_days(weeks * 7)
    }

    /// Adds months to the date
    pub fn add_months(&self, months: i32) -> DateResult<Self> {
    ...
    pub fn add_years(&self, years: i32) -> DateResult<Self> {
    ...
    pub fn first_of_month(&self) -> DateResult<Self> {
        Self::new(self.year(), self.month(), 1)
    }

    /// Returns the last day of the month
    pub fn last_of_month(&self) -> DateResult<Self> {
        let last_day = DateInner::days_in_month(self.year(), self.month());
        Self::new(self.year(), self.month(), last_day)
    }

    /// Returns the first day of the year
    pub fn first_of_year(&self) -> DateResult<Self> {
        Self::new(self.year(), 1, 1)
    }

    /// Returns the last day of the year
    pub fn last_of_year(&self) -> DateResult<Self> {
        Self::new(self.year(), 12, 31)
    }

    /// Returns the next weekday
    pub fn next_weekday(&self) -> DateResult<Self> {
        let dow = self.day_of_week();
    ...
    pub fn prev_weekday(&self) -> DateResult<Self> {
        let dow = self.day_of_week();
    ...
    pub fn unix_epoch() -> DateResult<Self> {
        Self::new(1970, 1, 1)
    }
