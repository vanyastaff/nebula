...
/// Rich, typed errors for DateTime operations
#[derive(Error, Debug, Clone, PartialEq, Eq)]
pub enum DateTimeError {
    #[error("Invalid datetime: {msg}")]
    Invalid { msg: String },
    ...
    #[error("Timezone error: {msg}")]
    TimezoneError { msg: String },

    #[error("Arithmetic overflow in datetime operation")]
    ArithmeticOverflow,

    #[error("System time error: {msg}")]
    SystemTimeError { msg: String },
...
pub struct DateTime {
    ...
    timestamp_cache: std::sync::OnceLock<i64>,
...
impl DateTime {
    ...
    pub fn from_date_time(date: Date, time: Time) -> Self {
        ...
        Self {
            inner: Arc::new(inner),
            timestamp_cache: std::sync::OnceLock::new(),
    ...
    pub fn from_system_time(st: SystemTime) -> DateTimeResult<Self> {
        ...
        if nanos > i64::MAX as u128 {
            return Err(DateTimeError::OutOfRange {
                msg: "SystemTime too far in the future".to_string(),
            });
        }
    ...
    pub fn parse_iso(s: &str) -> DateTimeResult<Self> {
    ...
    /// Adds a duration
    pub fn add_duration(&self, duration: StdDuration) -> DateTimeResult<Self> {
        let nanos = self.timestamp_nanos() + duration.as_nanos() as i64;
        Self::from_timestamp_nanos(nanos)
    }

    /// Subtracts a duration
    pub fn sub_duration(&self, duration: StdDuration) -> DateTimeResult<Self> {
        let nanos = self.timestamp_nanos() - duration.as_nanos() as i64;
        Self::from_timestamp_nanos(nanos)
    }

    /// Adds days
    pub fn add_days(&self, days: i64) -> DateTimeResult<Self> {
    ...
    /// Adds hours
    pub fn add_hours(&self, hours: i64) -> DateTimeResult<Self> {
        self.add_duration(StdDuration::from_secs((hours * 3600) as u64))
    }

    /// Adds minutes
    pub fn add_minutes(&self, minutes: i64) -> DateTimeResult<Self> {
        self.add_duration(StdDuration::from_secs((minutes * 60) as u64))
    }

    /// Adds seconds
    pub fn add_seconds(&self, seconds: i64) -> DateTimeResult<Self> {
...
impl Add<StdDuration> for DateTime {
    type Output = DateTimeResult<DateTime>;
