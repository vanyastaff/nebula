...
/// Outcome of [`Credential::resolve`](crate::credential_v2::Credential::resolve)
/// or [`Credential::continue_resolve`](crate::credential_v2::Credential::continue_resolve).
///
/// # Variants
///
...
/// [`Credential::refresh`](crate::credential_v2::Credential::refresh).
///
...
/// Outcome of
/// [`Credential::test`](crate::credential_v2::Credential::test).
...
/// [`Credential`](crate::credential_v2::Credential) trait:
