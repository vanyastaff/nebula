...
- 🛡️ **Safe**: Comprehensive testing and safety guarantees
...
- ⚠️ Miri compatibility pending (see [MIRI_LIMITATIONS.md](docs/MIRI_LIMITATIONS.md))

See [SAFETY.md](docs/SAFETY.md) for detailed safety guarantees.
