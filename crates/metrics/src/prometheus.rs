...
use crate::naming::{
    ...
    NEBULA_RESOURCE_ACQUIRE_WAIT_DURATION_SECONDS, NEBULA_RESOURCE_ACQUIRE_WAIT_MICROS_TOTAL,
    NEBULA_RESOURCE_ACQUIRE_WAITED_TOTAL, NEBULA_RESOURCE_CIRCUIT_BREAKER_CLOSED_TOTAL,
    NEBULA_RESOURCE_CIRCUIT_BREAKER_OPENED_TOTAL, NEBULA_RESOURCE_CLEANUP_TOTAL,
    ...
    NEBULA_RESOURCE_LEAKS_DETECTED_TOTAL, NEBULA_RESOURCE_POOL_EXHAUSTED_TOTAL,
    NEBULA_RESOURCE_POOL_WAITERS, NEBULA_RESOURCE_QUARANTINE_RELEASED_TOTAL,
    NEBULA_RESOURCE_QUARANTINE_TOTAL, NEBULA_RESOURCE_RELEASE_ERROR_TOTAL,
...
fn counter_help(name: &str) -> &'static str {
    match name {
        ...
        NEBULA_RESOURCE_RELEASE_ERROR_TOTAL => {
            "Total release-hook failures (observed, not swallowed)."
        },
        ...
        NEBULA_RESOURCE_ACQUIRE_WAITED_TOTAL => {
            "Total acquires whose wait exceeded the \"did not complete \
             immediately\" threshold."
        },
        NEBULA_RESOURCE_ACQUIRE_TIMED_OUT_TOTAL => {
            "Total acquires that failed after the caller's deadline had \
             already elapsed."
        },
        NEBULA_RESOURCE_ACQUIRE_WAIT_MICROS_TOTAL => {
            "Cumulative acquire wait time in microseconds across every attempt."
        },
        NEBULA_RESOURCE_LEAKS_DETECTED_TOTAL => {
