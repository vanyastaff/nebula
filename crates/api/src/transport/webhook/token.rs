...
//!
//! The separate `whsec_<base64>` signing secret is generated by an
//! API-private registration helper. Credential lookup and decoding are owned
//! by the deployment adapter behind [`super::WebhookSecretResolver`].
//!
//! # Security
//!
