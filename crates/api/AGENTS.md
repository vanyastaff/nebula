...
- `MembershipStore` exposes guarded organization mutations and parent-qualified workspace
  grant operations. Do not restore unguarded add/remove methods or a workspace-role lookup
  without the parent organization. Populate
