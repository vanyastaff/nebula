...
use nebula_validator::{DiagnosticDisclosure, ExecutionMode, Rule, RuleView, ValueRule};
...
use super::{
    ...
    model::{
        ...
        AdmissionLocation, ArrayBody, Body, Definition, DefinitionIndex, DefinitionKey,
        DefinitionLookup, DraftGraph, Edge, EdgeRole, EmptyPolicy, NullPolicy, NumericBody,
        PresencePolicy, PropertyUse, UnionBody, UseSiteCore, ValueProtection,
    },
...
use shape::presence_is_always_required;
