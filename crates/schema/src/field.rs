...
pub enum Field {
    ...
    /// recovered so the editor can still place and toggle it. Validation / lint /
    /// export and the compatibility check **treat an `Unknown` field as opaque**:
    /// this version cannot reason about its rules or its assignability.
