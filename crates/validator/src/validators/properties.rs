...
///
/// ```
/// use nebula_validator::validators::negative;
/// use nebula_validator::foundation::Validate;
///
...
///
/// ```
/// use nebula_validator::validators::even;
/// use nebula_validator::foundation::Validate;
///
/// let validator = even();
...
///
/// ```
/// use nebula_validator::validators::odd;
/// use nebula_validator::foundation::Validate;
///
/// let validator = odd();
...
///
/// ```
/// use nebula_validator::validators::non_zero;
/// use nebula_validator::foundation::Validate;
///
...
///
/// ```
/// use nebula_validator::validators::power_of_two;
/// use nebula_validator::foundation::Validate;
///
