-- ============================================================
-- 011: Service Accounts (machine identities)
-- ============================================================
...
CREATE TABLE service_accounts (
    ...
    -- Scope constraints (service accounts can be restricted to specific projects)
    allowed_project_ids UUID[] DEFAULT NULL,               -- NULL = all projects
